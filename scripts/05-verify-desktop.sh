...
if [ -z "$TARGET_USER" ]; then
    ...
    case "$DESKTOP_ENV" in
        ...
        shorinnocniri)
            check_config_exists "$HOME_DIR/.config/niri"
            check_config_exists "$HOME_DIR/.config/fcitx5"
            check_config_exists "$HOME_DIR/.config/gtk-3.0"
            check_config_exists "$HOME_DIR/.config/gtk-4.0"
            check_config_exists "$HOME_DIR/.config/kitty"
            check_config_exists "$HOME_DIR/.local/share/fcitx5/themes/NoctaliaOri"
