...
# 清理可能冲突的依赖
declare -a target_pkgs=( "hyprcursor-git"
 "hyprgraphics-git"
 "hyprland-git"
...
FM_PKGS="xdg-terminal-exec xdg-desktop-portal-gtk thunar tumbler ffmpegthumbnailer poppler-glib gvfs-smb file-roller thunar-archive-plugin gnome-keyring icoextract python-pillow thunar-volman gvfs-mtp gvfs-gphoto2 webp-pixbuf-loader rime-wanxiang-gram-zh-hans"
