...
TOOLS_PKGS=(imv cliphist wl-clipboard cliphist-tui-git shorin-contrib-git hyprlock breeze-cursors nwg-look adw-gtk-theme pavucontrol satty grim slurp opencode rime-wanxiang-gram-zh-hans shorin-proton-wrapper-git)
