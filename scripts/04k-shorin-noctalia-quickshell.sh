...
CORE_PKGS="noctalia-shell-git niri xwayland-satellite kitty xdg-desktop-portal-gnome niri-sidebar-git satty mpv"
...
TERM_PKGS="xdg-terminal-exec bat fuzzel wf-recorder wl-screenrec-git ttf-jetbrains-maple-mono-nf-xx-xx eza zoxide starship jq fish libnotify timg imv cava imagemagick wl-clipboard cliphist shorin-contrib-git shorin-proton-wrapper-git slurp opencode rime-wanxiang-gram-zh-hans"
...
THEME_PKGS="matugen adw-gtk-theme nwg-look"
