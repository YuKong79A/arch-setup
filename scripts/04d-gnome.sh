...
if exe as_user paru -S --noconfirm --needed $GNOME_BASE_PKGS; then
...
sudo -u $TARGET_USER paru -S --noconfirm --needed $EXT_CLI_PKGS
...
exe sudo -u $TARGET_USER paru -S --noconfirm --needed $FF_GNOME_PKGS
